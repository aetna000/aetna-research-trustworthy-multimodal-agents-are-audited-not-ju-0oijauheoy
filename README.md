# aetna-research-trustworthy-multimodal-agents-are-audited-not-ju-0oijauheoy
Reference implementation for Trustworthy Multimodal Agents Are Audited, Not Just Autonomous
## Article
Trustworthy Multimodal Agents Are Audited, Not Just Autonomous
The product bottleneck for multimodal agents is not action generation; it is evidence that makes every action auditable and trustworthy.
## Purpose
